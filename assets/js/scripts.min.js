! function(e) {
	...
	e.fn.fitVids = function(t) {
		...
		if (!document.getElementById("fit-vids-style")) {
			...
			r.className = "fit-vids-style", r.id = "fit-vids-style", r.style.display = "none", r.innerHTML = s, i.parentNode.insertBefore(r, i)
		}
		return t && e.extend(n, t), this.each(function() {
			...
			r = r.not("object object"), r.each(function() {
				var t = e(this);
				if (!("embed" === this.tagName.toLowerCase() && t.parent("object")
						.length || t.parent(".fluid-width-video-wrapper")
						.length)) {
					...
					t.wrap('<div class="fluid-width-video-wrapper"></div>')
						...
						.css("padding-top", 100 * i + "%"), t.removeAttr("height")
						.removeAttr("width")
				}
			})
		})
...
function(e) {
	var t, n, r, i, s, o, u, a = "Close",
		...
		N = function(n, r) {
			t.ev.triggerHandler(v + n, r), t.st.callbacks && (n = n.charAt(0)
				.toLowerCase() + n.slice(1), t.st.callbacks[n] && t.st.callbacks[n].apply(t, e.isArray(r) ? r : [r]))
		},
		C = function() {
		...
		A = function(n) {
			if (!e(n)
				...
				if (r && i) return !0;
				if (!t.content || e(n)
					.hasClass("mfp-close") || t.preloader && n === t.preloader[0]) return !0;
	...
	w.prototype = {
		...
		open: function(n) {
			...
			for (r = 0; r < a.length; r++) {
				var f = a[r];
				f = f.charAt(0)
					.toUpperCase() + f.slice(1), t["init" + f].call(t)
			}
			...
			t.fixedContentPos && (t.isIE7 ? e("body, html")
				.css("overflow", "hidden") : c.overflow = "hidden");
			var v = t.st.mainClass;
			t.isIE7 && (v += " mfp-ie7"), v && t._addClassToMFP(v), t.updateItemHTML(), N("BuildControls"), e("html")
				.css(c), t.bgOverlay.add(t.wrap)
				.prependTo(document.body), t._lastFocusedEl = document.activeElement, setTimeout(function() {
				...
				}, 16), t.isOpen = !0, t.updateSize(l), N(p)
		},
		close: function() {
		...
		_close: function() {
			...
			if (t.bgOverlay.detach(), t.wrap.detach(), t.container.empty(), t.st.mainClass && (n += t.st.mainClass + " "), t._removeClassFromMFP(n), t.fixedContentPos) {
				...
				t.isIE7 ? e("body, html")
					.css("overflow", "") : r.overflow = "", e("html")
					.css(r)
			}
			i.off("keyup" + m + " focusin" + m), t.ev.off(m), t.wrap.attr("class", "mfp-wrap")
				.removeAttr("style"), t.bgOverlay.attr("class", "mfp-bg"), t.container.attr("class", "mfp-container"), !t.st.showCloseBtn || t.st.closeBtnInside && t.currTemplate[t.currItem.type] !== !0 || t.currTemplate.closeBtn && t.currTemplate.closeBtn.detach(), t._lastFocusedEl && e(t._lastFocusedEl)
				.trigger("focus"), t.currItem = null, t.content = null, t.currTemplate = null, t.prevHeight = 0, N(l)
		},
		...
		updateItemHTML: function() {
			...
			var o = t["get" + r.charAt(0)
				.toUpperCase() + r.slice(1)](n, t.currTemplate[r]);
			t.appendContent(o, r), n.preloaded = !0, N(d, n), s = n.type, t.container.prepend(t.contentContainer), N("AfterChange")
		},
		appendContent: function(e, n) {
			t.content = e, e ? t.st.showCloseBtn && t.st.closeBtnInside && t.currTemplate[n] === !0 ? t.content.find(".mfp-close")
				.length || t.content.append(k()) : t.content = e : t.content = "", N(c), t.container.addClass("mfp-" + n + "-holder"), t.contentContainer.append(t.content)
		},
		parseEl: function(n) {
			var r = t.items[n],
				i = r.type;
		...
		addGroup: function(e, n) {
			...
			n.mainEl = e, n.items ? (n.isObj = !0, e.off(i)
				.on(i, r)) : (n.isObj = !1, n.delegate ? e.off(i)
				.on(i, n.delegate, r) : (n.items = e, e.off(i)
					.on(i, r)))
		},
		...
		updateStatus: function(e, r) {
			if (t.preloader) {
				...
				N("UpdateStatus", i), e = i.status, r = i.text, t.preloader.html(r), t.preloader.find("a")
					.on("click", function(e) {
		...
		modules: [],
		open: function(e, t) {
			return L(), e || (e = {}), e.isObj = !0, e.index = t || 0, this.instance.open(e)
		},
		close: function() {
		...
		else E ? r.data("magnificPopup", n) : r[0].magnificPopup = n, t.addGroup(r, n);
		return r
	};
	var M, _, D, P = "inline",
		H = function() {
			D && (_.after(D.addClass(M))
				.detach(), D = null)
		};
			...
			getInline: function(n, r) {
				if (H(), n.src) {
					...
					if (s.length) {
						...
						o && o.tagName && (_ || (M = i.hiddenClass, _ = T(M), M = "mfp-" + M), D = s.after(_)
							.detach()
	...
	e.magnificPopup.registerModule(j, {
		...
		proto: {
			initAjax: function() {
				t.types.push(j), B = t.st.ajax.cursor, x(a + "." + j, function() {
					F(), t.req && t.req.abort()
				})
			},
			getAjax: function(n) {
				B && r.addClass(B), t.updateStatus("loading");
				var i = e.extend({
					url: n.src,
					success: function(r, i, s) {
						...
						N("ParseAjax", o), t.appendContent(e(o.data), j), n.finished = !0, F(), C(), setTimeout(function() {
							t.wrap.addClass(g)
	...
	e.magnificPopup.registerModule("image", {
		...
		proto: {
			...
			getImage: function(n, r) {
				...
				if (a.length) {
					var f = new Image;
					f.className = "mfp-img", n.img = e(f)
						.on("load.mfploader", s)
						.on("error.mfploader", o), f.src = n.src, a.is("img") && (n.img = n.img.clone()), n.img[0].naturalWidth > 0 && (n.hasSize = !0)
				}
	...
	var R, U = function() {
		return void 0 === R && (R = void 0 !== document.createElement("p")
			.style.MozTransform), R
	};
			...
			initZoom: function() {
				...
				if (e.enabled && t.supportsTransition) {
					...
					x("BuildControls" + n, function() {
						if (t._allowZoom()) {
							if (clearTimeout(r), t.content.css("visibility", "hidden"), image = t._getItemToZoom(), !image) return u(), void 0;
							i = o(image), i.css(t._getOffset()), t.wrap.append(i), r = setTimeout(function() {
								i.css(t._getOffset(!0)), r = setTimeout(function() {
									u(), setTimeout(function() {
										i.remove(), image = i = null, N("ZoomAnimationEnded")
									}, 16)
								}, s)
							}, 16)
						}
						...
						if (t._allowZoom()) {
							if (clearTimeout(r), t.st.removalDelay = s, !image) {
		...
		proto: {
			initGallery: function() {
				...
				return t.direction = !0, n && n.enabled ? (o += " mfp-gallery", x(p + r, function() {
					...
					if (t.items.length > 1 && n.arrows && !t.arrowLeft) {
						var r = n.arrowMarkup,
							i = t.arrowLeft = e(r.replace("%title%", n.tPrev)
								.replace("%dir%", "left"))
							.addClass(b),
							o = t.arrowRight = e(r.replace("%title%", n.tNext)
								.replace("%dir%", "right"))
							.addClass(b),
					...
					i.off(r), t.wrap.off("click" + r), t.arrowLeft && s && t.arrowLeft.add(t.arrowRight)
						.destroyMfpFastClick(), t.arrowRight = t.arrowLeft = null
				}), void 0) : !1
			},
			next: function() {
			...
			_preloadItem: function(n) {
				if (n = V(n), !t.items[n].preloaded) {
					var r = t.items[n];
					r.parsed || (r = t.parseEl(n)), N("LazyLoad", r), "image" === r.type && (r.img = e('<img class="mfp-img" />')
	...
	e.magnificPopup.registerModule(J, {
		...
		function() {
			...
			e.fn.mfpFastClick = function(i) {
				...
				e(this)
					.off("touchstart" + s + " click" + s), n && S.off("touchmove" + s + " touchend" + s)
			}
		}()
